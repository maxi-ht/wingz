...
error ERC20InvalidReceiver(address sender);
...
contract WINGZ is IERC20 {
   ...
   constructor(string memory name_, string memory symbol_) {
    ...
    function transfer(address _to, uint256 _amount) public virtual returns (bool) {
        address owner = msg.sender;  // Usa msg.sender directamente
        _transfer(owner, _to, _amount);  // Corrige los parámetros de la función
    return true;
}
